...
SECONDS_PER_EPISODE = 20 # Original 10
EPISODE_FPS = 10  # Desired
IMG_WIDTH = 480
IMG_HEIGHT = 270
...
SPEED_MIN_REWARD = -1 # original -1
SPEED_MAX_REWARD = 1 # original 1
D2GOAL_MIN_REWARD = -1 # original -1
D2GOAL_MAX_REWARD = 1 # original 1
D2WP_MIN_REWARD = -1 # original -1
D2WP_MAX_REWARD = 1 # original 1
...
UPDATE_WEIGHTS_EVERY = 0  # How frequently tofuser update weights (compared to trainer fits), 0 for episode start only
...
START_EPSILON = 1
EPSILON_DECAY = 0.99995  # 0.99975   0.99995
MIN_EPSILON = 0.1
...
# Optimizer settings
OPTIMIZER_LEARNING_RATE = 0.001 #original 0.001
OPTIMIZER_DECAY = 0.0
...
# Console settings
SHOW_CARLA_ENV_SETTINGS = False # Originally False
