...
import carla
from sources.navigation.modified_controller import VehiclePIDController
from sources.navigation.misc import distance_vehicle, draw_waypoints
import math
    ...
    def run_step(self, debug=True):
        ...
        if len(self._waypoints_queue) == 0:
            ...
            next_wp = carla.Waypoint(
                carla.Transform(carla.Location(x=0, y=0, z=1), carla.Rotation(pitch=0, yaw=0, roll=0)))
            return d2wp,d2goal, 0, curr_wp, next_wp
        ...
        return d2wp,d2goal, len(self._waypoints_queue),self._current_waypoint, self.target_waypoint
